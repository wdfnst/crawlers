...
class Settings(object):
	...
	mysqlsettings   = {'host':'weardex.com', 'port':3306, 'user':'visenze', 'passwd':'lmsi3229visenzefashion', 'db':'visenze_fashion', 'charset':'utf8'}

	redissettings   = {'host':'localhost', 'port':6379, 'db':4}
